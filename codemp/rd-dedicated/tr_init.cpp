...
void R_Register( void )
{
	...
	r_ext_compressed_textures			= Cvar_Get( "r_ext_compress_textures",			"1",						CVAR_ARCHIVE_ND|CVAR_LATCH, "" );
	...
	r_ext_texture_filter_anisotropic	= Cvar_Get( "r_ext_texture_filter_anisotropic",	"16",						CVAR_ARCHIVE_ND, "" );
	r_DynamicGlow						= Cvar_Get( "r_DynamicGlow",					"0",						CVAR_ARCHIVE_ND, "" );
	...
	r_DynamicGlowWidth					= Cvar_Get( "r_DynamicGlowWidth",				"320",						CVAR_ARCHIVE_ND|CVAR_LATCH, "" );
	r_DynamicGlowHeight					= Cvar_Get( "r_DynamicGlowHeight",				"240",						CVAR_ARCHIVE_ND|CVAR_LATCH, "" );
	...
	r_vertexLight						= Cvar_Get( "r_vertexLight",					"0",						CVAR_ARCHIVE_ND|CVAR_LATCH, "" );
...
//	r_dlightBacks						= Cvar_Get( "r_dlightBacks",					"1",						CVAR_CHEAT, "" );
	...
	r_lodscale							= Cvar_Get( "r_lodscale",						"5",						CVAR_NONE, "" );
...
*/
	...
	broadsword							= Cvar_Get( "broadsword",						"0",						CVAR_NONE, "" );
