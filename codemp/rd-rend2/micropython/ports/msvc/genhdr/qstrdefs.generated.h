...
// added by hand
QDEF(MP_QSTR_openjk, (const byte*)"\x90\x27\x06" "openjk")
QDEF(MP_QSTR_getVelocity, (const byte*)"\x64\xf5\x0b" "getVelocity")
QDEF(MP_QSTR_setVelocity, (const byte*)"\x70\x52\x0b" "setVelocity")
