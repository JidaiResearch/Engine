...
void R_Register( void ) 
{
	...
	r_debugWeather						= Cvar_Get( "r_debugWeather",			"0",		CVAR_ARCHIVE, "" );
	...
	r_cubeMappingBounces = Cvar_Get("r_cubeMappingBounces", "0", CVAR_ARCHIVE | CVAR_LATCH, "");
	...
	r_mergeMultidraws = Cvar_Get("r_mergeMultidraws", "1", CVAR_ARCHIVE, "");
	r_mergeLeafSurfaces = Cvar_Get("r_mergeLeafSurfaces", "1", CVAR_ARCHIVE, "");
